...
static constexpr gpio_num_t PROVISION_BUTTON_PIN =
    static_cast<gpio_num_t>(CONFIG_OMNISMS_PROVISION_BUTTON_GPIO);
static constexpr uint32_t PROVISION_BUTTON_HOLD_MS = CONFIG_OMNISMS_PROVISION_BUTTON_HOLD_MS;
