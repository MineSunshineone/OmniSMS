...
static constexpr uart_port_t MODEM_UART = static_cast<uart_port_t>(CONFIG_OMNISMS_MODEM_UART_NUM);
static constexpr gpio_num_t MODEM_TXD = static_cast<gpio_num_t>(CONFIG_OMNISMS_MODEM_TX_GPIO);
static constexpr gpio_num_t MODEM_RXD = static_cast<gpio_num_t>(CONFIG_OMNISMS_MODEM_RX_GPIO);
static constexpr gpio_num_t MODEM_EN = static_cast<gpio_num_t>(CONFIG_OMNISMS_MODEM_EN_GPIO);
static constexpr int MODEM_BAUD = CONFIG_OMNISMS_MODEM_UART_BAUD;
